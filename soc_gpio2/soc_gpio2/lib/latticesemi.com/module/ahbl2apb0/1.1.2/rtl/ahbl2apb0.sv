    ...
    generate
        if ((APB_CLK_EN == 0)) 
            ...
            begin : dual_clk
                ...
                ahbl2apb0_ipgen_lscc_toggle_pulsesync slverr_sync (.src_clk(pclk_i), 
                            .src_rstn(presetn_i), 
                            .dst_clk(clk_i), 
                            .dst_rstn(rst_n_i), 
                            .din(p_pslverr_r), 
...
`timescale 1ns/1ps
module ahbl2apb0_ipgen_lscc_toggle_pulsesync (
    // clocks and resets
    ...
    // -- synchronizer --
    //-------------------
    ahbl2apb0_ipgen_lscc_sync #(.SYNC_STAGE(2),
            .DEST_RST_MODE("ASYNC"),
            .RST_INIT(1'b0),
...
`timescale 1ns/1ps
(* LATTICE_IP_MODULE=1 *) module ahbl2apb0_ipgen_lscc_sync #(parameter SYNC_STAGE = 2, 
