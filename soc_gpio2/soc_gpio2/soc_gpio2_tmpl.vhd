...
component soc_gpio2 is
    port (gpio2_o: inout std_logic_vector(31 downto 0);
        gpio_00_io: inout std_logic_vector(7 downto 0);
        rstn_i: in std_logic;
        uart_rxd_00_i: in std_logic;
        uart_txd_00_o: out std_logic
    );
    
end component soc_gpio2;
_inst: soc_gpio2 port map (gpio2_o => __,
                           rstn_i => __,
                           gpio_00_io => __,
                           uart_rxd_00_i => __,
                           uart_txd_00_o => __);
