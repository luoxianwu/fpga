...
module soc_gpio2 (gpio2_o, gpio_00_io, rstn_i, uart_rxd_00_i, uart_txd_00_o, soc_gpio2_pwm_o);
    ...
    wire apb0_inst_APB_M00_interconnect_PENABLE, apb0_inst_APB_M00_interconnect_PREADY, 
        ...
        apb0_inst_APB_M02_interconnect_PENABLE, apb0_inst_APB_M02_interconnect_PREADY, 
        apb0_inst_APB_M02_interconnect_PSELx, apb0_inst_APB_M02_interconnect_PSLVERR, 
        apb0_inst_APB_M02_interconnect_PWRITE;
    ...
    defparam ahbl0_inst.S1_ADDR_RANGE = 32'h40002400;
    ...
    cpu0 cpu0_inst (.ahbl_m_data_haddr_o({cpu0_inst_AHBL_M1_DATA_interconnect_HADDR}), 
         ...
         .clk_i(pll0_inst_clkop_o_net), .irq0_i(gpio0_inst_INTR_interconnect_IRQ), 
         .irq1_i(uart0_inst_INT_M0_interconnect_IRQ), .rst_n_i(expr_0_inst_O_net), 
    ...
    gpio0 gpio0_inst (.apb_paddr_i({apb0_inst_APB_M01_interconnect_PADDR[5:0]}), 
          ...
          .gpio_io({gpio_00_io}), .apb_penable_i(apb0_inst_APB_M01_interconnect_PENABLE), 
...
/*		  
    gpio2 gpio2_inst (.apb_paddr_i({apb0_inst_APB_M02_interconnect_PADDR[5:0]}), 
          .apb_prdata_o({apb0_inst_APB_M02_interconnect_PRDATA}), .apb_pwdata_i({apb0_inst_APB_M02_interconnect_PWDATA}), 
          .gpio_io({gpio2_o}), .apb_penable_i(apb0_inst_APB_M02_interconnect_PENABLE), 
