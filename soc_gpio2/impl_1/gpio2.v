...
// Netlist written on Thu Jun 26 10:25:54 2025
...
//
// Verilog Description of module gpio2
// module wrapper written out since it is a black-box. 
//

//

module gpio2 (gpio_io, clk_i, resetn_i, apb_penable_i, apb_psel_i, 
            apb_pwrite_i, apb_paddr_i, apb_pwdata_i, apb_prdata_o, apb_pslverr_o, 
            apb_pready_o, int_o) /* synthesis ORIG_MODULE_NAME="gpio2", LATTICE_IP_GENERATED="1", cpe_box=1 */ ;
    inout [31:0]gpio_io;
    input clk_i;
    input resetn_i;
    input apb_penable_i;
