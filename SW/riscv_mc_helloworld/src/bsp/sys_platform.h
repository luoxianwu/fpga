...
#define SPI_INST_NAME "SPI_inst"
#define SPI_INST_BASE_ADDR 0x8800
...
/* SPI_inst parameters */
#define SPI_INST_ACTUAL_CLOCK_FREQ 0.1
#define SPI_INST_BB_PRIM_EN False
#define SPI_INST_CPHA 0
#define SPI_INST_CPOL 0
#define SPI_INST_DATA_WIDTH 16
#define SPI_INST_DATA_WIDTH_RESET 1
#define SPI_INST_DESIRED_CLOCK_FREQ 0.1
#define SPI_INST_FAMILY LIFCL
#define SPI_INST_FIFO_DEPTH 16
#define SPI_INST_FIFO_IMPL EBR
#define SPI_INST_FIFO_WIDTH 16
#define SPI_INST_INTERFACE APB
#define SPI_INST_LSB_FIRST 0
#define SPI_INST_ONLY_WRITE 0
#define SPI_INST_PRESCALER 250
#define SPI_INST_PRESCALER_INPUT 250
#define SPI_INST_RX_FIFO_AF_FLAG 12
#define SPI_INST_SLAVE_COUNT 8
#define SPI_INST_SPI_EN 0
#define SPI_INST_SPI_EN_IN False
#define SPI_INST_SSNP 1
#define SPI_INST_SSPOL 0x00
#define SPI_INST_SYS_CLOCK_FREQ 50.0
#define SPI_INST_TX_FIFO_AE_FLAG 3
#define SPI_INST_SLV_SEL_POL 00
