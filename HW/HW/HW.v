...
//
module HW (CS, led_o, MISO_i, MOSI, clk_o, rstn_i, rxd_i, txd_o);
    output [7:0]CS;
    inout [7:0]led_o;
    input MISO_i;
    output MOSI;
    ...
    wire apb0_inst_APB_M02_interconnect_PENABLE, apb0_inst_APB_M02_interconnect_PREADY, 
        ...
        apb0_inst_APB_M02_interconnect_PWRITE, pll0_inst_clkos_o_net, SPI_inst_INTR_interconnect_IRQ, 
    ...
    SPI SPI_inst (.apb_paddr_i({apb0_inst_APB_M02_interconnect_PADDR[5:0]}), 
        .apb_prdata_o({apb0_inst_APB_M02_interconnect_PRDATA}), .apb_pwdata_i({apb0_inst_APB_M02_interconnect_PWDATA}), 
        .ssn_o({CS}), .apb_penable_i(apb0_inst_APB_M02_interconnect_PENABLE), 
        ...
        .clk_i(pll0_inst_clkos_o_net), .int_o(SPI_inst_INTR_interconnect_IRQ), 
        .miso_i(MISO_i), .mosi_o(MOSI), .rst_n_i(cpu0_inst_system_resetn_o_net), 
        .sclk_o(clk_o));
    ...
    apb0 apb0_inst (.apb_m00_paddr_mstr_o({apb0_inst_APB_M00_interconnect_PADDR}), 
         ...
         .apb_m02_pwrite_mstr_o(apb0_inst_APB_M02_interconnect_PWRITE), .apb_pclk_i(pll0_inst_clkos_o_net), 
    ...
    cpu0 cpu0_inst (.ahbl_m_data_haddr_o({cpu0_inst_AHBL_M1_DATA_interconnect_HADDR}), 
         ...
         .irq1_i(gpio0_inst_INTR_interconnect_IRQ), .irq2_i(SPI_inst_INTR_interconnect_IRQ), 
         .rst_n_i(equation_module0_inst_O_net), .system_resetn_o(cpu0_inst_system_resetn_o_net));
